...
public class ProductDAOImpl implements ProductDAO {
	...
	public List<Product> listActiveProductsByCategory(int cetegoryId) {
		String selectActiveProductsByCategory = "FROM Product WHERE active = :active AND cetegoryId = :cetegoryId";
		return sessionFactory
				.getCurrentSession()
					.createQuery(selectActiveProductsByCategory, Product.class)
						.setParameter("active", true)
						.setParameter("cetegoryId",cetegoryId)
							.getResultList();
	}
