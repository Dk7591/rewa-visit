CREATE TABLE cetegory (
	...
	is_active BOOLEAN,
	CONSTRAINT pk_cetegory_id PRIMARY KEY (id) 
...
CREATE TABLE product (
	...
	CONSTRAINT pk_product_id PRIMARY KEY (id),
 	CONSTRAINT fk_product_cetegory_id FOREIGN KEY (cetegory_id) REFERENCES cetegory (id),
...
INSERT INTO cetegory (name, discription,image_url,is_active) VALUES ('Laptop', 'This is discription for Laptop cetegory!', 'CAT_1.png', true);
INSERT INTO cetegory (name, discription,image_url,is_active) VALUES ('Television', 'This is discription for Television cetegory!', 'CAT_2.png', true);
INSERT INTO cetegory (name, discription,image_url,is_active) VALUES ('Mobile', 'This is discription for Mobile cetegory!', 'CAT_3.png', true);
-- adding three users 
...
INSERT INTO product (code, name, brand, discription, unit_price, quantity, is_active, cetegory_id, supplier_id, purchases, views)
