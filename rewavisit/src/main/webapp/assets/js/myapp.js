...
var $table = $('#productListTable');
	...
	if ($table.length) {
		...
		if(window.cetegoryId=='')
			...
			{
			jsonUrl=window.contextRoot + '/json/data/cetegory/'+ window.cetegoryId + '/products';
			}
		$table.DataTable({
			
			lengthMenu: [[3,5,7,10,-1], ['3 Records','5 Records','7 Records','10 Records']],
			pageLength: 5,
			ajax: {
				url: jsonUrl,
				dataSrc:''
